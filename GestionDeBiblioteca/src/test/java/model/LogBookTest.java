...
public class LogBookTest {
    ...
    public void setUp() {
        ...
        user = new User("maria@gmail.com", "password", new ArrayList<>(), new Date(), "ID001", "chacon", "maria", "88888888");
    ...
    public void testGettersAndSetters() {
        ...
        User newUser = new User("dayana@gmail.com", "password", new ArrayList<>(), new Date(), "ID002", "monge", "dayana", "88888888");
